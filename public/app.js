...
/***/ "./public/assets/js/components/cart.js":
/*!*********************************************!*\
  !*** ./public/assets/js/components/cart.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  return {
    ...
    add: async function (productId) {
      try {
        const {
          data
        } = await _services_http__WEBPACK_IMPORTED_MODULE_0__["default"].post('/cart/add', {
          productId
        });
    ...
    subtotal: function (productId, price) {
      ...
      return `x ${quantity} = ${(0,_services_currency__WEBPACK_IMPORTED_MODULE_1__["default"])('pt-BR', 'BRL', quantity * price)}`;
    },
    remove: async function (productId) {
      try {
        const {
          data
        } = await _services_http__WEBPACK_IMPORTED_MODULE_0__["default"].get('/cart/remove', {
          params: {
            productId
          }
        });
    ...
    clear: async function () {
      const {
        data
      } = await _services_http__WEBPACK_IMPORTED_MODULE_0__["default"].post('/cart/clear');
      localStorage.setItem('cart', JSON.stringify(data));
      this.productsInCart = data;
    }
  };
...
/* harmony export */ });
function currency(format, currency, value) {
...
/* harmony import */ var _components_cart__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/cart */ "./public/assets/js/components/cart.js");


window.Alpine = alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"];
window.cart = _components_cart__WEBPACK_IMPORTED_MODULE_1__["default"];
